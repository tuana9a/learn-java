package com.tuana9a.annotations;
...
@SupportedAnnotationTypes("com.tuana9a.annotations.Builder")
        ...
        for (TypeElement annotation : annotations) {
            ...
            annotatedElements.forEach(element -> {
                try {
                    ...
                    Handler handler = new FileHandler("./annotation.log", true);
                    logger.addHandler(handler);
                    logger.info("process " + result + "Builder success");
                } catch (IOException e) {
